...
def applya():
    ...
    if request.method == 'POST' :
        ...
        url = 'https://insiteplus.herokuapp.com/create' #API CALL
        myobj = {'name': name,
                 'email' : email,
                 'address' : address,
                 'phone' : phone}
...
def updatee():
    if request.method == 'PUT' or request.method == 'POST'  :
        ...
        myobj = {"address": address,
                ...
                "name": name,
                "phone": phone}
        url = 'https://insiteplus.herokuapp.com/update' #API CALL
...
def deletee():
    if request.method == 'DELETE' or request.method == 'POST'  :
        ...
        if account[0]==email:
            ...
            url = 'https://insiteplus.herokuapp.com/delete/'+id #API CALL
